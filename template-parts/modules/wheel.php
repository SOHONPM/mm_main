<section class="wheel-section">
    <div class="svgWrap"> <svg height="" width="">
            <line class="hide" id="1" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
        <svg height="" width="">
            <line class="hide" id="6" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
        <svg height="" width="">
            <line class="hide" id="2" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
        <svg height="" width="">
            <line class="hide" id="7" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
        <svg height="" width="">
            <line class="hide" id="3" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
        <svg height="" width="">
            <line class="hide" id="8" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
        <svg height="" width="">
            <line class="hide" id="4" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
        <svg height="" width="">
            <line class="hide" id="9" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
        <svg height="" width="">
            <line class="hide" id="5" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
        <svg height="" width="">
            <line class="hide" id="10" x1="0" y1="0" x2="0" y2="0" style="stroke:rgb(255,0,0);stroke-width:2" /> </svg>
    </div>
    <div class="container">
        <div class="wrapper">
            <div class="rotation-wrapper-outer">
                <div class="rotation-wrapper-inner">
                    ...
                    <div class="ray ray1">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="rayLeft noRotate" style="-webkit-transform: rotate(-90deg);">ENOUGH MONEY<br>10</div>
                                <table class="money">
                                    <tbody>
                                        <tr>
                                            <td>
                                ...
                                <!-- <div class="dimensionLabel">ENOUGHMONEY
                                </div> -->
                            </div>
                            <div class="col-md-6">
                                <div class="rayRight noRotate" style="-webkit-transform: rotate(90deg);">HEALTH<br>10</div>
                    ...
                    <div class="ray ray2">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="rayLeft">10<br>BUSINESS / CAREER</div>
                                ...
                                <!-- <div class="dimensionLabel" style="-webkit-transform: rotate(36deg)">BUSINESS/CAREER
                                </div> -->
                            </div>
                            <div class="col-md-6">
                                <div class="rayRight">SELF DEVELOPMENT<br>10</div>
                                ...
                                <!-- <div class="dimensionLabelRight" style="-webkit-transform: rotate(36deg)">SELF DEVELOPMENT
                                </div> -->
                            </div>
                        </div>
                    </div>
                    <div class="ray ray3">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="rayLeft">10<br>SOCIAL / FRIENDS</div>
                                ...
                                <!-- <div class="dimensionLabel" style="-webkit-transform: rotate(72deg)">SOCIAL/FRIENDS
                                </div> -->
                            </div>
                            <div class="col-md-6">
                                <div class="rayRight">
                                    CIRCLE OF INSPIRATION <br>10
                                </div>
                                ...
                                <!-- <div class="dimensionLabelRight" style="-webkit-transform: rotate(72deg)">CIRCLE OF INSPIRATION
                                </div> -->
                            </div>
                        </div>
                    </div>
                    <div class="ray ray4">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="rayLeft">10<br>LOVE / INTIMACY</div>
                                ...
                                <!-- <div class="dimensionLabel" style="-webkit-transform: rotate(108deg);">LOVE/INTIMACY
                                </div> -->
                            </div>
                            <div class="col-md-6">
                                <div class="rayRight">ADVENTURE / LIFESTYLE <br>10</div>
                                ...
                                <!-- <div class="dimensionLabelRight" style="-webkit-transform: rotate(108deg)">ADVENTURE/LIFESTYLE
                                </div> -->
                            </div>
                        </div>
                    </div>
                    <div class="ray ray5">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="rayLeft">10<br>FAMILY LIFE</div>
                                ...
                                <!-- <div class="dimensionLabel" style="-webkit-transform: rotate(144deg);">FAMILY LIFE&nbsp;
                                </div> -->
                            </div>
                            <div class="col-md-6">
                                <div class="rayRight">CONTRIBUTION / IMPACT <br> 10</div>
                                ...
                                <!-- <div class="dimensionLabelRight">CONTRIBUTION / IMPACT
                                </div> -->
                            </div>
                        </div>
                    </div>
